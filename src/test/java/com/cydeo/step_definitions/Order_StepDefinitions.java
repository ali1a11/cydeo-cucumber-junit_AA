...
//    }
    ...
    // we change string input quantity to int below

    @And("user enters quantity {int}")
    public void userEntersQuantity(int quantity) {

        //accepting int argument and sending it using sendKeys() method
        //since sendKeys() method only accepts String,
        //we need too either concat with "" or use String.valueOf(int) method

        // We can delete existing data suing sendKeys(Keys.BACK_SPACE) or .clear()
        // .clear() method will delete whatever is in the input box

        //orderPage.inputQuantity.sendKeys(Keys.BACK_SPACE);
        orderPage.inputQuantity.clear();

        orderPage.inputQuantity.sendKeys(quantity + ""); //int to String
        // orderPage.inputQuantity.sendKeys(String.valueOf(quantity));   //int to String
